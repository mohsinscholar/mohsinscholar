...
<ul style="margin: 0; padding-left: 20px;">
  ...
  <li>🔬 <b>Research & Publications:</b> Specialized in Symmetric-Key Cryptography, AI Security, & Digital Forensics; co-author of 3 peer-reviewed papers.</li>
  <li>💻 <b>Technical Expertise:</b> Proficient in C#, VB.NET, Python, MySQL, and secure software development within Visual Studio environments.</li>
  <li>🛠️ <b>System Automation:</b> Experienced in designing custom automation scripts and optimizing database workflows to eliminate manual bottlenecks.</li>
  <li>☁️ <b>Cloud & Certifications:</b> NAVTTC certified in AWS Cloud Computing with strong foundations in secure infrastructure management.</li>
  <li>🤖 <b>Current Focus:</b> Actively mastering Agentic AI Architectures, autonomous multi-agent workflows, and intelligent automated systems.</li>
